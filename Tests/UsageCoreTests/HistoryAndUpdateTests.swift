...
final class ProjectNameTests: XCTestCase {
    ...
    func testTakesTheWorkingDirectoryLeaf() {
        XCTAssertEqual(
            TranscriptScanner.projectName("/Users/alex/code/my-app"), "my-app")
        // Transcripts are written on Windows too.
        XCTAssertEqual(
            TranscriptScanner.projectName(#"C:\Users\Alex\Documents\js_projects\my_app"#), "my_app")
        XCTAssertEqual(TranscriptScanner.projectName("/Users/alex/code/"), "code")
    }
