...
/// Checks GitHub for a newer release and reports it. Informational only — the
/// App Store build gets its updates from the App Store, so this never offers
/// to install anything, only a link. Harmless to leave enabled: a 404 against
/// a repo that doesn't exist yet just means "no update found."
///
/// TODO: point this at your actual GitHub repo once you've pushed it.
public actor UpdateChecker {
    public static let shared = UpdateChecker()

    static let endpoint = URL(
        string: "https://api.github.com/repos/emadbeyrami/claude-usage-mac/releases/latest")!
