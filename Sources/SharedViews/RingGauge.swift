...
extension Snapshot {
    ...
    static var preview: Snapshot {
        ...
        stats.projects = [
            ProjectUsage(name: "usage-monitor", tokens: 4_100_000, cost: 11.80,
                         todayTokens: 720_000, todayCost: 2.05, days: recentDays(900_000)),
            ProjectUsage(name: "api-gateway", tokens: 2_600_000, cost: 7.40,
                         todayTokens: 310_000, todayCost: 0.90, days: recentDays(600_000)),
            ProjectUsage(name: "internal-tools", tokens: 1_100_000, cost: 3.10,
