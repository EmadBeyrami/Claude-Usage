#!/usr/bin/env bash
# Build Claude Usage.app and install it to /Applications, for local testing.
#
# Signs with whatever identity your Apple Developer account resolves via
# Automatic signing (project.yml pins DEVELOPMENT_TEAM). Requires full Xcode,
# not just the Command Line Tools, and a Mac you're signed into Xcode on.
set -euo pipefail
cd "$(dirname "$0")"
