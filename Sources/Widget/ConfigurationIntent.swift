...
/// fails it fails *silently*, arriving as nil and rendering the default
/// account, which looks exactly like the user's choice being ignored. A
/// String is a primitive: there is no type registry involved, so there is
/// nothing to fail.
